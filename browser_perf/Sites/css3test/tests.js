...
window.Specs = {
	//整个css3-background是一个Test对象
	//该对象中共含有18个测试
	"css3-background": {
		"title": "Backgrounds and Borders",
		//这里的 key value  对应的是css的key 和 value
		"properties": {
			//经过组合 background-repeat 的值是有18个value的数组
	...
	"css3-images": {
		...
		// 这里的values中的properties就是css中的key  其他的都是值  只不过这里的值作了分组
		// 所以这里是
		// background-image:linear-gradient:(white,black);
		// background-image:linear-gradient(to right, white, black);
		// 也就是properties 和其他值的排列组合
		"values": {
			"properties": [
				"background-image",
				"list-style-image",
	...
	"css3-ui": {
		...
		"properties": {
			...
			"text-overflow": ["clip", "ellipsis"].times(1, 2),
			"cursor": [
